...
void setDirection(byte inputData){           // Get input and set Direction 
    int lastXDir = xDir;
    int lastYDir = yDir;
    
    if(inputData==128 && lastDirectionChange == 'N'){
      xDir = lastYDir;
      yDir = -lastXDir;
      lastDirectionChange = 'L';
    }
    if(inputData==0 && lastDirectionChange == 'N'){  
      xDir = -lastYDir;
      yDir = lastXDir;
